...
namespace RetailERP.Migrations
{
    ...
    [Migration("20260405045256_Sprint22_InvoiceTemplateSelectionPersistence")]
    partial class Sprint22_InvoiceTemplateSelectionPersistence
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RetailERP.Data.Entities.BillTemplate", b =>
                {
                    ...
                    b.Property<bool>("EnableFreeItemQuantity")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("ShowPartyBalance")
                        .HasColumnType("bit");

                    b.Property<bool>("ShowPhoneOnInvoice")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("RetailERP.Data.Entities.Company", b =>
                {
                    ...
                    b.Property<string>("GatewayKeyId")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("GatewayKeySecret")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("RetailERP.Data.Entities.FranchiseMappingRequest", b =>
                {
                    b.Property<Guid>("FranchiseMappingRequestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("MappedOperatorCompanyId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("RequestedOperatorCity")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("RequestedOperatorCode")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("RequestedOperatorName")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("RequestedOperatorState")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<Guid>("RequestingCompanyId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RetailERP.Data.Entities.InvoiceNumberingRule", b =>
                {
                    b.Property<Guid>("InvoiceNumberingRuleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("InvoiceNumberingRuleId");
            ...
            modelBuilder.Entity("RetailERP.Data.Entities.NotificationLog", b =>
                {
            ...
            modelBuilder.Entity("RetailERP.Data.Entities.NotificationTemplate", b =>
                {
            ...
            modelBuilder.Entity("RetailERP.Data.Entities.PortalAccessLink", b =>
                {
                    b.Property<Guid>("PortalAccessLinkId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RetailERP.Data.Entities.PortalReturnRequest", b =>
                {
                    b.Property<Guid>("PortalReturnRequestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RetailERP.Data.Entities.StockAdjustmentRequest", b =>
                {
                    ...
                    b.Property<Guid?>("AppliedStockTransactionId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RetailERP.Data.Entities.SupplierPoResponse", b =>
                {
                    b.Property<Guid>("SupplierPoResponseId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RetailERP.Data.Identity.ApplicationUser", b =>
                {
                    ...
                    b.Property<Guid?>("DefaultPosStoreId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("DefaultPosWarehouseId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RetailERP.Data.Entities.NotificationLog", b =>
                {
                    ...
                    b.HasOne("RetailERP.Data.Entities.NotificationTemplate", "Template")
                        .WithMany()
